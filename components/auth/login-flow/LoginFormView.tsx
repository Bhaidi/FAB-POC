...
import { authInputFieldStyles } from "@/components/auth/authInputStyles";
...
import { authColors, authLoginFormVertical } from "@/components/auth/authTokens";
      ...
      core={
        ...
        >
          <VStack align="stretch" spacing={0} w="full" position="relative">
            <VStack align="stretch" spacing={authLoginFormVertical.betweenInputs} w="full">
              <Box {...fieldStackProps}>
                <Text
                  fontFamily="var(--font-graphik)"
                  fontWeight={500}
